...
#         )
#         df_clean["credit_limit"] = df_clean["credit_limit"].apply(lambda x: np.nan if x == 0 else x) # noqa: E501
...
#             df_clean["profile_tags"].str.replace("'", "").str.replace(",", "").str.replace("+", "") # noqa: E501
#         )
#         # Setando o algoritmo
...
#         df_tag = pd.DataFrame(words, columns=bag_of_words.get_feature_names(), index=df_clean.index) # noqa: E501
...
#         return {"X_train": X_train_rus, "X_test": X_test, "y_train": y_train_rus, "y_test": y_test} # noqa: E501
#     input_table = Table(
#         name="risk_data",
#         metadata=Metadata(
#             schema="public",
